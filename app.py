...
client = OpenAI(
    api_key=os.getenv(xai-4UfJL2EV8TAfQHTwRHaJupuqFrdZccmmNvNlQ7L6AwmuifCOhStkabSzK2FzXwOJZFP2PIRsCiReBySP),  # Add your key to .env as XAI_API_KEY=your_key_here
